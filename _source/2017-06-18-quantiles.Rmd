...
measurements is above a certain threshold. We
...
integer. Since the CFR itself only operates with the samples sizes 100, 60, 40, 20, 10 and 5
...
read in the article the removal is highly controversial, in particular because a consequence was that with
...
`type=1`. For our application $p$ would be `r p` and the 90th percentil
