...
illustrating how to find 90% confidence intervals for the `r p*100`%
quantile of the standard normal distribution based on the above sample
of size $n$=`r n` says this in less than 1000 words.

```{r,PREPAREPICTURE,cache=TRUE,echo=FALSE,results='hide'}
