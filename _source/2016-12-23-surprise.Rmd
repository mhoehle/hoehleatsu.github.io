...
p2 <- ggplot(surprise, aes(x=weight,fill=figure_fac)) + geom_bar() + xlab("Weight (g)") + ylab("Eggs") + scale_fill_manual(name="Content:",values=c("figure"="#66C2A5","no figure"="#FC8D62"))
