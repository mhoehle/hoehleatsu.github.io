...
vacation. Frequently the teacher, with a look of secrecy, initializes
...
data are available under a GPL v3.0 license from github. For
...
p1 <- ggplot(surprise, aes(x=figure_fac, y= weight)) + geom_boxplot() + xlab("") + ylab("Weight (g)")
p2 <- ggplot(surprise, aes(x=weight,fill=figure_fac)) + geom_bar() + xlab("Weight (g)") + ylab("Eggs") + scale_fill_manual(name="Figure inside?",values=c("yes"="#66C2A5","no"="#FC8D62"))
