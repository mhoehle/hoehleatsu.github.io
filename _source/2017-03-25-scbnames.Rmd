...
cat(paste0("![]({{ site.baseurl }}/",knitr::opts_chunk$get("fig.path"),"COLLISION26-1.png"),")")
```
</center>
...
substantially over the years - going from `r sprintf("%.1f%%",(names_join %>% filter(year==2004) %$%
propNames1)*100)` in 2004 to `r sprintf("%.1f%%",(names_join %>%
filter(year==2016) %$% propNames1)*100)` in 2016. It's not clear if
