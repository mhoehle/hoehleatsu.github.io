...
under the CC BY license. The 2015 population data are available as CSV
file through the same
...
With the help of the powerful `rgdal`, `sp` and the `rgeos` CRAN
packages, R can be used as a
...
SpatialPolygonsDataFrame object names `pgrs` - see GitHub code for
details.
