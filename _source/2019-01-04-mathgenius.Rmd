...
Besides possible solutions one can view the result of evaluating all possible combinations in the "Details" tab. We invite you to experiment with the app or download the [source code of the Shiny app](`r paste0("https://raw.githubusercontent.com/hoehleatsu/hoehleatsu.github.io/master/_source/",current_input(),"mathgenius", "app.R")`) from github for the full math experience. `r emo::ji("smiley")`
