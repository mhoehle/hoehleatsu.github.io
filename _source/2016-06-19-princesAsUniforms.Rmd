...
We illustrate the prior setting consisting of $l=`r prior_1$l`$ and $u=`r prior_1$u`$ and two values of $k$:
...
ggplot(theta.grid, aes(x=alpha,y=beta,z=value))+ stat_contour() +
  facet_grid( . ~ k_type) +
