...
We perform a social experiment to investigate, if zombie related twitter posts can be used as a reliable indicator for an early warning system. We show how such a system can be set up almost out-of-the-box using R - a free software environment for statistical computing and graphics. **Warning**: This blog entry contains toxic doses of Danish irony and sarcasm as well as disturbing graphs. **Update**: The blog post was extended with additional data, graphs and text at `r Sys.time()`. Scroll to the end of the post for details.
...
#The one used for the latest post
tw <- readRDS(file=paste0(filePath,"Tweets-Database-",safe_query,"-","2016-10-02",".RDS"))
#tw <- readRDS(file=paste0(filePath,"Tweets-Database-",safe_query,"-","2016-10-18",".RDS"))
#tw <- readRDS(file=paste0(filePath,"Tweets-Database-",safe_query,"-","2016-10-29",".RDS"))
