...
`type=1`. For our application $p$ would be 0.9 and the 90th percentil
...
more
[didactic whiteboard explanation](https://youtu.be/9pql00zr700)
by Professor
[Christopher Gardiner](http://www.emich.edu/math/faculty/cgardiner.php)
for [Michigan Radio](http://michiganradio.org/post/video-how-dropping-two-flints-lead-test-numbers-changed-things-state) on how to calculate the 90% quantile
