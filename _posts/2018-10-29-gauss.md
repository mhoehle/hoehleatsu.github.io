...
packages by @henrikBengtsson (https://twitter.com/henrikbengtsson):
...
enter the baseline values. In particular the non-parametric method,
...
as an outbreak. A simple fix to avoid confusion could be to chop the
