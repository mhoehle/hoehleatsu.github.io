...
##  
## threshold: 142.1391  
## area of the high-risk zone: 2574507
```
...
##   <dbl>   <dbl>      <dbl>         <dbl> <dbl>
## 1 0.051 0.00118      0.999        0.0509  44.3
```
...
bomb lies as low as 0.051. This is quite close to the
above described approximate conversion from $p_{\text{miss}}$ (0.051 vs. 0.051). Changing the
...
##   p_out p_miss `1-p_miss` p_out_derived    nZ
##   <dbl>  <dbl>      <dbl>         <dbl> <dbl>
## 1  0.47 0.0143      0.986         0.511  49.6
```
