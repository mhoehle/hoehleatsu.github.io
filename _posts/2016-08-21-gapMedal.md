...
```
## Error: 'gg_animate' is not an exported object from 'namespace:gganimate'
```


```
## Warning in file.rename("olympicMedals-gapminder-style.gif", file.path(fullFigPath, :
## cannot rename file 'olympicMedals-gapminder-style.gif' to '/Users/hoehle/Sandbox/Blog/
## figure/source/2016-08-21-gapMedal//olympicMedals-gapminder-style.gif', reason 'No such
## file or directory'
```
...
```
## Error in mutate_impl(.data, dots): Evaluation error: could not find function "countrycode".
```
...
```
## Error in geom_flag(data = medals_gm1990 %>% filter(Year == y), aes(x = GDPpc, : could not find function "geom_flag"
```


```
## Warning in file.rename("olympicMedals-flags.gif", file.path(fullFigPath, : cannot rename
## file 'olympicMedals-flags.gif' to '/Users/hoehle/Sandbox/Blog/figure/source/2016-08-21-
## gapMedal//olympicMedals-flags.gif', reason 'No such file or directory'
```
...
```
## Warning in file.rename("olympicMedals-perpop-gapminder-style.gif",
## file.path(fullFigPath, : cannot rename file 'olympicMedals-perpop-gapminder-style.gif'
## to '/Users/hoehle/Sandbox/Blog/figure/source/2016-08-21-gapMedal//olympicMedals-perpop-
## gapminder-style.gif', reason 'No such file or directory'
```
