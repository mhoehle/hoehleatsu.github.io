...
```{r POPDYNAMICS, fig.width=8, fig.height=6}
...
As an example, the highest mortality in the 65+ age-group occurs in `r sprintf("2020-W%0.2d",bl_max$Woche)` in the federal state of `r bl_max$Bundesland`, where the unadjusted mortality is `r scales::percent(bl_max$oe_ratio - 1)` above the mean of 2016-2019.
